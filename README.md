...
## Panda flashing
This is done automatically otherwise run `cd /data/openpilot/panda/board; ./flash.sh; scons -u; reboot` Make sure this done while your device is connnect to your car:
...
`DP084-clean`: Current development branch.
...
- Braking:
    ...
    - by curvature (mapd),
    - by mapped sign(stop, yield, roundabouts, bump, hump, traffic light, speed sign, road attribute) by [alfhern](https://github.com/move-fast)
