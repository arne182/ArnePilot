...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate in [CAR.PRIUS, CAR.PRIUS_2019]:
      ...
      stop_and_go = True
      ret.safetyParam = 56 # make sure to change the dbc to avoide steering erros. dbc is set to 0.56
      ret.wheelbase = 2.68986
      ret.steerRatio = 14.3
      tire_stiffness_factor = 0.7933
      ret.mass = 3370. * CV.LB_TO_KG + STD_CARGO_KG
      ret.longitudinalTuning.kpV = [2.1, 1.3, 0.34]
      ...
      if spairrowtuning:
        ...
        ret.lateralTuning.indi.outerLoopGainV = [14, 20.99, 20.99, 23]
