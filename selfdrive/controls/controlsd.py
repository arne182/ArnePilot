...
class Controls:
  ...
  def state_control(self, CS):
    ...
    # Gas/Brake PID loop
    actuators.gas, actuators.brake = self.LoC.update(self.active, CS, v_acc_sol, long_plan.vTargetFuture, a_acc_sol, self.CP, self.sm, plan.hasLead, self.sm['radarState'], plan.decelForTurn, plan.longitudinalPlanSource)
  ...
  def publish_logs(self, CS, start_time, actuators, v_acc, a_acc, lac_log):
    ...
    controlsState.decelForTurn = self.sm['plan'].decelForTurn #need to move it to new file.
